...
//#endregion
//#region \0dsh-css:C:\Users\zhen.luo\AppData\Local\Temp\dsh-plugin-wallpapers-pr\src\client\WallpaperDialog.module.css.mjs
const css$1 = ".LEPQLq_pickerDialog.LEPQLq_pickerDialog{width:min(720px,100%)}.LEPQLq_content{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex-direction:column;gap:12px;height:min(560px,100dvh - 96px);min-height:0;display:flex}.LEPQLq_content>*{min-height:0}.LEPQLq_toolbar{flex:none;align-items:center;gap:12px;display:flex}.LEPQLq_search{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);font:inherit;color:var(--dsw-alias-label-primary);border-radius:10px;outline:none;flex:auto;padding:6px 12px;font-size:13px}.LEPQLq_search:focus{border-color:var(--dsw-alias-border-l4)}.LEPQLq_kinds{gap:4px;display:flex}.LEPQLq_kind{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:8px;padding:4px 12px;font-size:13px;line-height:18px}.LEPQLq_kind:hover{color:var(--dsw-alias-label-primary)}.LEPQLq_kindSelected{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary)}.LEPQLq_gridWrap{flex:auto;min-height:0;padding-right:4px;overflow-y:auto}.LEPQLq_grid{grid-template-columns:repeat(auto-fill,minmax(200px,1fr));align-content:start;gap:12px;display:grid}.LEPQLq_card{border:.5px solid var(--dsw-alias-border-l4);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border-radius:12px;flex-direction:column;gap:8px;padding:0;display:flex;position:relative;overflow:hidden}.LEPQLq_card:hover{background:var(--dsw-alias-interactive-bg-hover)}.LEPQLq_cardSelected{border-color:var(--dsw-alias-brand-primary)}.LEPQLq_cardUnsupported{opacity:.45;cursor:not-allowed}.LEPQLq_thumb{aspect-ratio:16/9;background:var(--dsw-alias-bg-layer-1);flex:none;width:100%;display:block}.LEPQLq_thumbImage{object-fit:cover;width:100%;height:100%;display:block}.LEPQLq_thumbFallback{width:100%;height:100%;display:block}.LEPQLq_meta{flex-direction:column;gap:2px;padding:0 12px 10px;display:flex}.LEPQLq_name{text-overflow:ellipsis;white-space:nowrap;font-size:13px;line-height:18px;overflow:hidden}.LEPQLq_sub{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:16px}.LEPQLq_badge{background:var(--dsw-alias-brand-primary);color:#fff;border-radius:6px;padding:2px 8px;font-size:11px;line-height:14px;position:absolute;top:8px;right:8px}.LEPQLq_note{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.LEPQLq_noteError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.LEPQLq_audio{color:var(--dsw-alias-label-primary);flex:none;align-items:center;gap:8px;font-size:13px;line-height:20px;display:flex}";
...
var WallpaperDialog_module_css_default = {
	...
	"name": "LEPQLq_name",
	"grid": "LEPQLq_grid",
	"toolbar": "LEPQLq_toolbar",
	"search": "LEPQLq_search",
	"kinds": "LEPQLq_kinds",
	"meta": "LEPQLq_meta",
	"gridWrap": "LEPQLq_gridWrap",
	"thumbFallback": "LEPQLq_thumbFallback",
	"cardUnsupported": "LEPQLq_cardUnsupported",
	"sub": "LEPQLq_sub",
	"note": "LEPQLq_note",
	"badge": "LEPQLq_badge",
	"thumb": "LEPQLq_thumb",
	"kind": "LEPQLq_kind",
	"kindSelected": "LEPQLq_kindSelected",
	"thumbImage": "LEPQLq_thumbImage",
	"cardSelected": "LEPQLq_cardSelected",
	"pickerDialog": "LEPQLq_pickerDialog",
	"content": "LEPQLq_content",
	"noteError": "LEPQLq_noteError"
};
...
//#endregion
//#region \0dsh-css:C:\Users\zhen.luo\AppData\Local\Temp\dsh-plugin-wallpapers-pr\src\client\WallpaperRow.module.css.mjs
const css = ".yZLTfa_group{border-bottom:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.yZLTfa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.yZLTfa_description{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}.yZLTfa_controls{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.yZLTfa_chooseButton{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);max-width:100%;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border-radius:10px;padding:6px 16px;font-size:14px;line-height:20px;overflow:hidden}.yZLTfa_chooseButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yZLTfa_clearButton{box-sizing:border-box;font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:10px;padding:6px 12px;font-size:14px;line-height:20px}.yZLTfa_clearButton:hover{color:var(--dsw-alias-label-primary)}.yZLTfa_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
...
var WallpaperRow_module_css_default = {
	"chooseButton": "yZLTfa_chooseButton",
	"error": "yZLTfa_error",
	"description": "yZLTfa_description",
	"title": "yZLTfa_title",
	"group": "yZLTfa_group",
	"controls": "yZLTfa_controls",
	"clearButton": "yZLTfa_clearButton"
};
...
//#endregion
//#region \0dsh-inline-css:C:\Users\zhen.luo\AppData\Local\Temp\dsh-plugin-wallpapers-pr\src\client\wallpaper-layer.css.mjs
